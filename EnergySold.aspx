<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="EnergySold.aspx.cs" Inherits="EnergySold" %>
        ...
        <div>
            ...
            <div class="input-group">
                <div class="form-inline">    
                    <h3 class="alert alert-danger">Energy Sold Table</h3>          
                    <table border="0" cellpadding="5" cellspacing="5" class="table bg-success table-responsive ">
                         <tr>
                            <td  class="alert-info">
                             ...
                             <td>
                                <asp:TextBox runat="server" ID="txtName"  placeholder="Consumer Name" required  CssClass="form-control"/>
                            </td>
                            ...
                            <td>
                                 <asp:TextBox runat="server" ID="txtFiscalCode"  placeholder="FiscalCode" required CssClass="form-control"/>
                            </td>

                             <td class="alert-info">
                                <span>QuantityEnergy</span>
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="txtQuantityEnergy"  placeholder="QuantityEnergy" required  CssClass="form-control"/>
                            </td>
                        </tr>
                          <tr>
                             <td class="alert-info">
                            ...
                            <td>
                                ...
                                <asp:ListItem Text="SelectProducer" Value="select" Selected="True"></asp:ListItem>  
                                <asp:ListItem Text="Smart User2" Value="Smart User_2"></asp:ListItem>  
                                <asp:ListItem Text="Smart User3" Value="Smart User_3"></asp:ListItem>  
                                 
                        </asp:DropDownList>  
                            </td>
                              <td class="alert-info">
                                <span>SelectDistance</span>
                            </td>
                            <td>
                                <asp:DropDownList ID="DropDownList3" runat="server">  
                                <asp:ListItem Text="SelectDistance" Value="select" Selected="True"></asp:ListItem>  
                                <asp:ListItem Text="0-1 km" Value="0-1 km"></asp:ListItem>  
                                <asp:ListItem Text="1-10 km" Value="1-10 km"></asp:ListItem>  
                                <asp:ListItem Text="10-15 km" Value="10-15 km"></asp:ListItem>  
                                 
                        </asp:DropDownList>  
                             </td>
                               <td class="alert-info">
                                <span>Select_DM_Per_Km</span>
                            </td>
                            <td>
                                <asp:DropDownList ID="DropDownList4" runat="server">  
                                <asp:ListItem Text="Select_DM_Per_Km" Value="select" Selected="True"></asp:ListItem>  
                                <asp:ListItem Text="5" Value="5DV"></asp:ListItem>  
                                <asp:ListItem Text="6" Value="6DV"></asp:ListItem>  
                                <asp:ListItem Text="7" Value="7DV"></asp:ListItem>  
                        ...
                        <tr>
                            ...
                            <td  class="alert-info">
                                ...
                                (Eth)</td>
                             <td>
                                <asp:TextBox runat="server" ID="txtCost"  placeholder="Cost" required  CssClass="form-control"/>
                            </td>
                           
                            <td>
                                <asp:Button Text="Buy" runat="server" ID="Button3" 
                                    class="btn btn-sm btn-primary" OnClick="btnBuy_Click" />
                            </td> 
          ...
          <asp:GridView ID="GridView3" runat="server" 
                ...
                DataKeyNames="TransactionId" DataSourceID="LibraryDb" BorderColor="#66CCFF">
              <Columns>
